...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    private static final int ALIGN_PARENT_LEFT = 0x01;
    private static final int ALIGN_PARENT_RIGHT = 0x02;
    private static final int CENTER_HORIZONTAL = 0x03;

    @IntDef({ALIGN_PARENT_LEFT, ALIGN_PARENT_RIGHT,CENTER_HORIZONTAL})
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        ...
        canLoop = a.getBoolean(R.styleable.ConvenientBanner_recyclable, true);
        autoTurningTime = a.getInteger(R.styleable.ConvenientBanner_switchDuration, -1);
        a.recycle();
        init(context);
    }
     ...
     * @return
     */
    public ConvenientBanner setPageIndicatorAlign(@IndicatorAlign int align) {
        LayoutParams layoutParams = (LayoutParams) loPageTurningPoint.getLayoutParams();
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, align == ALIGN_PARENT_LEFT ? RelativeLayout.TRUE : 0);
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, align == ALIGN_PARENT_RIGHT ? RelativeLayout.TRUE : 0);
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL, align == CENTER_HORIZONTAL ? RelativeLayout.TRUE : 0);
